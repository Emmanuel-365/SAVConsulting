...
export function Security() {
  return (
    <section className="py-20 md:py-32 bg-emerald-950 text-white overflow-hidden relative min-h-[800px] flex items-center">
      
      {/* 1. COMPLEX SVG BACKGROUND (Retro Grid + Radial Glow) */}
      <RetroGrid className="opacity-20" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] md:w-[1000px] h-[600px] md:h-[1000px] bg-emerald-600/10 rounded-full blur-[120px] -z-0" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 md:gap-20 items-center">
          ...
          <div className="lg:w-1/2 text-center lg:text-left relative">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-emerald-500/30 bg-emerald-500/10 text-rose-300 text-xs md:text-sm font-medium mb-6">
            ...
            <div className="hidden lg:block relative h-64 w-full">
               ...
               >
                  <svg viewBox="0 0 200 200" className="w-full h-full stroke-emerald-500/50 fill-none stroke-[0.5]">
               ...
               <motion.div 
                 ...
                 className="absolute top-1/2 left-1/4 h-10 w-10 bg-emerald-600/20 backdrop-blur-md rounded-lg border border-emerald-500/30 flex items-center justify-center"
               >
               ...
               <motion.div 
                 ...
                 className="absolute top-1/3 right-1/4 h-12 w-12 bg-emerald-600/20 backdrop-blur-md rounded-xl border border-emerald-500/30 flex items-center justify-center"
               >
                  <ShieldCheck size={20} className="text-rose-300"/>
               </motion.div>
            </div>
          </div>
          ...
          <div className="lg:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full">
            {securityPoints.map((point, index) => (
              <motion.div
                ...
                className="group p-6 md:p-8 rounded-[2rem] bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 hover:border-emerald-500/50 transition-all duration-500"
              >
                <div className="h-12 w-12 rounded-2xl bg-emerald-600/20 text-rose-300 flex items-center justify-center mb-6 border border-emerald-500/20 group-hover:scale-110 group-hover:bg-emerald-600 group-hover:text-white transition-all duration-500 shadow-[0_0_20px_rgba(16,185,129,0)] group-hover:shadow-[0_0_20px_rgba(16,185,129,0.3)]">
                  <point.icon size={24} />
                </div>
