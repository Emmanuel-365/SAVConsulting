      ...
      <section className="py-24 container mx-auto px-4">
        <div className="grid lg:grid-cols-3 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-1 space-y-12">
            ...
            <div className="p-6 rounded-2xl bg-emerald-950 text-white border border-emerald-900 shadow-xl">
            ...
            <div className="bg-white rounded-3xl shadow-xl shadow-emerald-900/5 border border-emerald-50 p-8 md:p-12">
              ...
              {isSuccess ? (
                <div className="flex flex-col items-center justify-center text-center py-12 space-y-4 animate-in fade-in zoom-in duration-500 bg-emerald-50 rounded-2xl border border-emerald-100">
                  ...
                  <h3 className="text-2xl font-bold text-emerald-900">Bien reçu !</h3>
                  <Button variant="outline" className="mt-6 border-emerald-200 text-emerald-700 hover:bg-emerald-100" onClick={() => setIsSuccess(false)}>Nouvelle demande</Button>
                </div>
              ) : (
