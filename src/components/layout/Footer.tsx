...
export function Footer() {
  return (
    <footer className="bg-slate-950 text-slate-200 border-t border-slate-800 pt-16 pb-32 md:pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-400">
              <li><Link href="/services/saisie-comptable" className="hover:text-blue-400 transition-colors">Saisie Comptable</Link></li>
              <li><Link href="/services/externalisation-paie" className="hover:text-blue-400 transition-colors">Externalisation Paie</Link></li>
              <li><Link href="/secteurs/immobilier" className="hover:text-blue-400 transition-colors">Compta Immobilier</Link></li>
              <li><Link href="/#pricing" className="hover:text-blue-400 transition-colors">Tarifs Marque Blanche</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-400">
              <li><Link href="/a-propos" className="hover:text-blue-400 transition-colors">À Propos</Link></li>
              <li><Link href="/notre-equipe" className="hover:text-blue-400 transition-colors">Notre Équipe</Link></li>
              <li><Link href="/etudes-de-cas" className="hover:text-blue-400 transition-colors">Études de Cas</Link></li>
              <li><Link href="/processus-integration" className="hover:text-blue-400 transition-colors">Processus Intégration</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-400">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:contact.savconsulting@gmail.com" className="hover:text-white truncate">contact.savconsulting@gmail.com</a>
              </li>
            </ul>
          </div>
