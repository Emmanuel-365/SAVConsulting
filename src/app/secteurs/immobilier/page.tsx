    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-24 container mx-auto px-4 text-left">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl font-bold text-slate-900 mb-6">Le marché de l&apos;immobilier demande de la <span className="text-emerald-600 italic">réactivité</span>.</h2>
          ...
          <div className="relative">
             <div className="bg-emerald-950 rounded-[2.5rem] p-12 text-white shadow-2xl border border-emerald-900 text-left">
