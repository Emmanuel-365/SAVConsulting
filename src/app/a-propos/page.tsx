      ...
      <section className="py-24 bg-blue-50/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-blue-900">Nos Valeurs Fondamentales</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {values.map((v, i) => (
              <div key={i} className="bg-white p-8 rounded-2xl border border-blue-100 shadow-sm text-center hover:border-rose-100 transition-colors">
                <div className="h-12 w-12 rounded-xl bg-rose-50 text-rose-400 flex items-center justify-center mx-auto mb-6">
                  <v.icon size={24} />
                </div>
                <h3 className="font-bold text-xl text-blue-900 mb-2">{v.title}</h3>
