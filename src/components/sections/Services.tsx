      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-20">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="inline-flex items-center rounded-full border px-3 py-1 text-sm font-medium text-rose-600 bg-rose-50 mb-4"
          >
            Offre 360°
          </motion.div>
          <motion.h2 
          ...
          >
            Glissez pour découvrir nos pôles d&apos;expertise. <span className="md:hidden inline-block ml-2 animate-pulse text-rose-500">👉</span>
          </motion.p>
        </div>
        ...
        <div className="flex flex-row overflow-x-auto snap-x snap-mandatory gap-4 pb-8 -mx-4 px-4 md:grid md:grid-cols-3 md:gap-6 md:pb-0 md:mx-auto md:px-0 scrollbar-hide">
          ...
          >
             <div>
                <div className="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-rose-50 text-rose-500">
             ...
             <div className="flex flex-col md:flex-row items-center justify-between gap-8">
               <div className="flex-1">
                  <div className="flex items-center gap-3 mb-4">
                     ...
                     <span className="text-xs font-bold uppercase tracking-wider text-rose-300 border border-rose-800 px-2 py-1 rounded">Notre limite</span>
                  </div>
