...
import { TrendingUp, Clock, CheckCircle, ArrowRight, User } from "lucide-react";
...
const cases = [
  {
    ...
    solution: "Mise en place d'une équipe dédiée de 2 ETP chez SAV Consulting sous 1 semaine. Accès direct via leur GED.",
    ...
    stats: [
      ...
      { label: "Économie réalisée", value: "40%" },
      { label: "Délai mise en place", value: "5j" }
    ],
  ...
  },
  {
    ...
    result: "Aucun retard de déclaration. Le cabinet a décidé de pérenniser l'externalisation paie pour se concentrer sur le conseil RH.",
    stats: [
  ...
  {
    title: "Groupe Gamma (National) - 150 Collab.",
    problem: "Volonté d'optimiser la marge sur le portefeuille LMNP (faible valeur ajoutée, gros volume).",
    solution: "Processus industriel mis en place sur MyUnisoft. Automatisation des flux et validation par lots.",
    result: "Marge multipliée par 2 sur ce segment. Les collaborateurs internes ne font plus que la révision finale.",
    stats: [
      { label: "LMNP traités", value: "450" },
      { label: "Gain productivité", value: "3h/dossier" },
      { label: "Rentabilité", value: "x2" }
    ],
    tags: ["Immobilier", "LMNP", "Industrialisation"]
  }
];
    ...
    <main className="min-h-screen bg-white">
                ...
                <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100">
                   ...
                   <div className="mt-8 flex flex-wrap gap-2">
                      {study.tags.map((tag, k) => (
                        <span key={k} className="px-3 py-1 bg-white border border-slate-200 rounded-full text-xs font-medium text-slate-600">
                           {tag}
                        </span>
                      ))}
                   </div>
      ...
      <section className="py-24 bg-blue-600 text-white text-center">
         <div className="container mx-auto px-4 max-w-3xl">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Prêt à écrire votre success story ?</h2>
            <p className="text-blue-100 text-lg mb-10">
               Chaque cabinet est unique. Discutons de vos enjeux spécifiques lors d&apos;un audit gratuit.
            </p>
            <Button size="lg" className="bg-white text-blue-600 hover:bg-slate-50 h-14 px-8 rounded-full shadow-xl font-bold" asChild>
