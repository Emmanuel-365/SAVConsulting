      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:w-1/2 w-full">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold text-blue-950 mb-4 md:mb-6 leading-tight">
            ...
            <div className="relative space-y-8 md:space-y-12 pl-2">
              ...
              <div className="absolute left-[27px] top-4 bottom-4 w-0.5 bg-blue-50 -z-10" />
              ...
              {steps.map((step, index) => (
                ...
                >
                  ...
                  <div className="relative flex-shrink-0">
                    <div className="w-14 h-14 rounded-2xl bg-white border border-blue-100 shadow-sm flex items-center justify-center text-blue-600 group-hover:border-blue-200 group-hover:shadow-blue-50 transition-all duration-300 z-10 relative">
                      <step.icon className="h-6 w-6" />
                    </div>
                    {/* Number Badge */}
                    <div className="absolute -top-2 -right-2 bg-blue-950 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-md shadow-sm">
                      {step.number}
                    </div>
                  </div>
                  ...
                  <div className="pt-1 text-left">
                    <h3 className="font-bold text-lg md:text-xl text-blue-950 group-hover:text-blue-600 transition-colors">
                      {step.title}
                    </h3>
          ...
          >
             <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-blue-50 aspect-[4/5] bg-blue-50/20">
                <Image 
                ...
                <div className="absolute bottom-10 left-10 right-10 bg-white/95 backdrop-blur-md p-6 rounded-2xl border border-blue-100 shadow-xl">
                  <div className="flex items-start gap-4">
                     <div className="h-10 w-10 rounded-full bg-blue-50 flex items-center justify-center text-blue-600 font-bold shrink-0">JD</div>
                     <div>
                        ...
                        <div className="mt-3 flex items-center gap-2">
                           ...
                           <span className="text-xs text-blue-600 font-semibold uppercase tracking-wider">Jean D. - Expert-Comptable (Paris)</span>
                        </div>
                     </div>
                  </div>
                </div>
