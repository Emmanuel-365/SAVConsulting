...
export function Security() {
  return (
    <section className="py-20 md:py-32 bg-blue-950 text-white overflow-hidden relative min-h-[800px] flex items-center">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 md:gap-20 items-center">
          ...
          <div className="lg:w-1/2 text-center lg:text-left relative">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-blue-500/30 bg-blue-500/10 text-rose-300 text-xs md:text-sm font-medium mb-6">
              ...
              <p className="text-base md:text-xl text-blue-100/60 leading-relaxed max-w-md mx-auto lg:mx-0 mb-12">
          ...
          <div className="lg:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full">
            {securityPoints.map((point, index) => (
              ...
              >
                <div className="h-12 w-12 rounded-2xl bg-blue-600/20 text-rose-300 flex items-center justify-center mb-6 border border-blue-500/20 group-hover:scale-110 group-hover:bg-blue-600 group-hover:text-white transition-all duration-500 shadow-[0_0_20px_rgba(16,185,129,0)] group-hover:shadow-[0_0_20px_rgba(16,185,129,0.3)]">
                  <point.icon size={24} />
                </div>
