    ...
    <section className="py-24 bg-white">
      <div className="container mx-auto px-4 max-w-3xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-emerald-900 mb-4">Questions fréquentes</h2>
        </div>
        ...
        >
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-1">
              <AccordionTrigger className="text-lg text-emerald-900 hover:text-emerald-600 hover:no-underline py-6">
                Où sont stockées les données de mes clients ?
              </AccordionTrigger>
              <AccordionContent className="text-emerald-500 leading-relaxed text-base pb-6">
