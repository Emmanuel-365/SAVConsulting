          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <ul className="space-y-4 mb-10">
                ...
                <li className="flex items-center gap-3">
                  <div className="h-2 w-2 rounded-full bg-rose-400" />
                  <span className="text-emerald-100">Respect strict des calendriers DSN</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="h-2 w-2 rounded-full bg-rose-400" />
                  <span className="text-emerald-100">Confidentialité absolue des données</span>
                </li>
              </ul>
              <Button size="lg" className="bg-emerald-600 hover:bg-emerald-700 h-14 px-8 rounded-full shadow-xl shadow-emerald-900/40 font-bold" asChild>
