    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-20 container mx-auto px-4 max-w-4xl">
        <div className="space-y-12 text-slate-600 leading-relaxed">
          ...
          <div>
            <h2 className="text-2xl font-bold text-blue-900 mb-4">Protection des données clients</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold text-blue-900 mb-4">Mesures de sécurité</h2>
